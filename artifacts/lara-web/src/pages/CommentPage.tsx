    ...
    <div style={{ minHeight: "100vh", paddingBottom: 40 }}>
      {loading && (
        <div className="loading-overlay">
          ...
          <p style={{ fontSize: 16, fontWeight: 700, color: "#fff" }}>Posting Comments...</p>
      ...
      <div className="tool-header">
        ...
        <div style={{ flex: 1 }}>
          ...
          <p style={{ fontSize: 11, color: "rgba(255,255,255,0.32)" }}>Bulk Comment Booster · Max 10</p>
        </div>
      ...
      <div style={{ padding: "16px 20px 0" }}>
        ...
        {accountCount > 0 && (
          <div className="boost-banner" style={{ marginBottom: 14, background: useAll ? "rgba(34,197,94,0.08)" : "rgba(99,102,241,0.06)", borderColor: useAll ? "rgba(34,197,94,0.25)" : "rgba(99,102,241,0.18)", transition: "all 0.25s" }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 12, color: "#fff", fontWeight: 600 }}>Comment All {accountCount} Accounts</div>
              <div style={{ fontSize: 10, color: "rgba(255,255,255,0.35)" }}>No cooldown · Max 10 comments each</div>
            </div>
            <button onClick={() => setUseAll(u => !u)} style={{
              width: 46, height: 26, borderRadius: 13, flexShrink: 0,
              background: useAll ? "linear-gradient(135deg,#10b981,#22c55e)" : "rgba(255,255,255,0.1)",
        ...
        {/* Comments textarea */}
        <div style={{ marginBottom: 14 }}>
          <label style={{ display: "flex", justifyContent: "space-between", fontSize: 10, fontWeight: 700, color: "rgba(255,255,255,0.28)", letterSpacing: "0.12em", marginBottom: 7 }}>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
          {[
            ...
            <div key={label} style={{ flex: 1, background: "rgba(139,92,246,0.07)", border: `1px solid ${warn ? "rgba(245,158,11,0.3)" : "rgba(139,92,246,0.15)"}`, borderRadius: 10, padding: "10px 8px", textAlign: "center" }}>
              ...
              <div style={{ fontSize: 10, color: "rgba(255,255,255,0.32)", marginTop: 2 }}>{label}</div>
